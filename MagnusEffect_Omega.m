...
%Propri�t� de la balle en rotation
R = 1;
L_Omega = [0,  pi/10,  pi/5,  2*pi/5];
Cx = 0.4;
m = 0.5;
...
for ij=1:4
  ...
  while ((niter<nitermax))
    ...
    % Define the obstacle
      ...
      %Force de trainee et de Magnus th�orique
...
title('Trajectoire pour differentes vitesse de rotation')
legend('Omega = 0', 'Omega = pi/10', 'Omega = pi/5', 'Omega = 2*pi/5');
